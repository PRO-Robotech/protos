...
func (c *secGroupServiceClient) SyncStatuses(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (SecGroupService_SyncStatusesClient, error) {
...
func (c *secGroupServiceClient) ListHosts(ctx context.Context, in *ListHostsReq, opts ...grpc.CallOption) (*ListHostsResp, error) {
	...
	err := c.cc.Invoke(ctx, SecGroupService_ListHosts_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *secGroupServiceClient) ListServices(ctx context.Context, in *ListServicesReq, opts ...grpc.CallOption) (*ListServicesResp, error) {
	...
	err := c.cc.Invoke(ctx, SecGroupService_ListServices_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *secGroupServiceClient) ListIECidrSvcRules(ctx context.Context, in *ListIECidrSvcRulesReq, opts ...grpc.CallOption) (*ListIECidrSvcRulesResp, error) {
	out := new(ListIECidrSvcRulesResp)
	err := c.cc.Invoke(ctx, SecGroupService_ListIECidrSvcRules_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *secGroupServiceClient) GetSecGroupForHost(ctx context.Context, in *GetSecGroupForHostReq, opts ...grpc.CallOption) (*SecGroup, error) {
	out := new(SecGroup)
	err := c.cc.Invoke(ctx, SecGroupService_GetSecGroupForHost_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSecGroupServiceServer) SyncStatuses(*empty.Empty, SecGroupService_SyncStatusesServer) error {
...
func (UnimplementedSecGroupServiceServer) ListIECidrSvcRules(context.Context, *ListIECidrSvcRulesReq) (*ListIECidrSvcRulesResp, error) {
...
func _SecGroupService_ListSvcSvcRules_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListSvcSvcRulesReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SecGroupServiceServer).ListSvcSvcRules(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SecGroupService_ListSvcSvcRules_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SecGroupService_ListIECidrSvcRules_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListIECidrSvcRulesReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SecGroupServiceServer).ListIECidrSvcRules(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SecGroupService_ListIECidrSvcRules_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SecGroupServiceServer).ListIECidrSvcRules(ctx, req.(*ListIECidrSvcRulesReq))
	}
	return interceptor(ctx, in, info, handler)
}
