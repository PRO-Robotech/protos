...
const file_sgroups_service_proto_rawDesc = "" +
	"\n" +
	"\x15sgroups/service.proto\x12\x0ehbf.v2.sgroups\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1cgoogle/api/annotations.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\x1a\x15sgroups/queries.proto\x1a\x15sgroups/domains.proto2\xe3\x1a\n" +
	...
	"\x0fListSvcSvcRules\x12\".hbf.v2.sgroups.ListSvcSvcRulesReq\x1a#.hbf.v2.sgroups.ListSvcSvcRulesResp\"m\x92AI\x1aGListSvcSvcRules: lists Service-to-Service Rule(s) by variety of scopes'\x82\xd3\xe4\x93\x02\x1b:\x01*\"\x16/v2/list-service-rules\x12\xa1\x01\n" +
	...
	"\x15FindIECidrSgIcmpRules\x12(.hbf.v2.sgroups.FindIECidrSgIcmpRulesReq\x1a%.hbf.v2.sgroups.IECidrSgIcmpRulesResp\"\x80\x01\x92AY\x1aWFindIECidrSgIcmpRules: finds CIDR-SG-[INGRESS|EGRESS]:ICMP rule(s) scoped by variety SG\x82\xd3\xe4\x93\x02\x1e:\x01*\"\x19/v2/ie-cidr-sg-icmp-rules\x1a \x92A\x1d\x12\x1bSecurity Groups API serviceB\xac\x01\x92Aq\x12\x1a\n" +
...
var file_sgroups_service_proto_goTypes = []any{
	...
	(*GetSgSubnetsReq)(nil),          // 7: hbf.v2.sgroups.GetSgSubnetsReq
	(*GetSecGroupForAddressReq)(nil), // 8: hbf.v2.sgroups.GetSecGroupForAddressReq
	(*GetSecGroupForHostReq)(nil),    // 9: hbf.v2.sgroups.GetSecGroupForHostReq
	(*FindSgSgRulesReq)(nil),         // 10: hbf.v2.sgroups.FindSgSgRulesReq
	(*FindFqdnRulesReq)(nil),         // 11: hbf.v2.sgroups.FindFqdnRulesReq
	(*FindSgIcmpRulesReq)(nil),       // 12: hbf.v2.sgroups.FindSgIcmpRulesReq
	(*FindSgSgIcmpRulesReq)(nil),     // 13: hbf.v2.sgroups.FindSgSgIcmpRulesReq
	(*FindIECidrSgRulesReq)(nil),     // 14: hbf.v2.sgroups.FindIECidrSgRulesReq
	(*FindIESgSgRulesReq)(nil),       // 15: hbf.v2.sgroups.FindIESgSgRulesReq
	(*FindIESgSgIcmpRulesReq)(nil),   // 16: hbf.v2.sgroups.FindIESgSgIcmpRulesReq
	(*FindIECidrSgIcmpRulesReq)(nil), // 17: hbf.v2.sgroups.FindIECidrSgIcmpRulesReq
	...
	(*ListSvcSvcRulesResp)(nil),      // 23: hbf.v2.sgroups.ListSvcSvcRulesResp
	(*GetSgSubnetsResp)(nil),         // 24: hbf.v2.sgroups.GetSgSubnetsResp
	(*SecGroup)(nil),                 // 25: hbf.v2.sgroups.SecGroup
	(*SgSgRulesResp)(nil),            // 26: hbf.v2.sgroups.SgSgRulesResp
	(*FqdnRulesResp)(nil),            // 27: hbf.v2.sgroups.FqdnRulesResp
	(*SgIcmpRulesResp)(nil),          // 28: hbf.v2.sgroups.SgIcmpRulesResp
	(*SgSgIcmpRulesResp)(nil),        // 29: hbf.v2.sgroups.SgSgIcmpRulesResp
	(*IECidrSgRulesResp)(nil),        // 30: hbf.v2.sgroups.IECidrSgRulesResp
	(*IESgSgRulesResp)(nil),          // 31: hbf.v2.sgroups.IESgSgRulesResp
	(*IESgSgIcmpRulesResp)(nil),      // 32: hbf.v2.sgroups.IESgSgIcmpRulesResp
	(*IECidrSgIcmpRulesResp)(nil),    // 33: hbf.v2.sgroups.IECidrSgIcmpRulesResp
}
var file_sgroups_service_proto_depIdxs = []int32{
	...
	7,  // 8: hbf.v2.sgroups.SecGroupService.GetSgSubnets:input_type -> hbf.v2.sgroups.GetSgSubnetsReq
	8,  // 9: hbf.v2.sgroups.SecGroupService.GetSecGroupForAddress:input_type -> hbf.v2.sgroups.GetSecGroupForAddressReq
	9,  // 10: hbf.v2.sgroups.SecGroupService.GetSecGroupForHost:input_type -> hbf.v2.sgroups.GetSecGroupForHostReq
	10, // 11: hbf.v2.sgroups.SecGroupService.FindSgSgRules:input_type -> hbf.v2.sgroups.FindSgSgRulesReq
	11, // 12: hbf.v2.sgroups.SecGroupService.FindFqdnRules:input_type -> hbf.v2.sgroups.FindFqdnRulesReq
	12, // 13: hbf.v2.sgroups.SecGroupService.FindSgIcmpRules:input_type -> hbf.v2.sgroups.FindSgIcmpRulesReq
	13, // 14: hbf.v2.sgroups.SecGroupService.FindSgSgIcmpRules:input_type -> hbf.v2.sgroups.FindSgSgIcmpRulesReq
	14, // 15: hbf.v2.sgroups.SecGroupService.FindIECidrSgRules:input_type -> hbf.v2.sgroups.FindIECidrSgRulesReq
	15, // 16: hbf.v2.sgroups.SecGroupService.FindIESgSgRules:input_type -> hbf.v2.sgroups.FindIESgSgRulesReq
	16, // 17: hbf.v2.sgroups.SecGroupService.FindIESgSgIcmpRules:input_type -> hbf.v2.sgroups.FindIESgSgIcmpRulesReq
	17, // 18: hbf.v2.sgroups.SecGroupService.FindIECidrSgIcmpRules:input_type -> hbf.v2.sgroups.FindIECidrSgIcmpRulesReq
	...
	23, // 26: hbf.v2.sgroups.SecGroupService.ListSvcSvcRules:output_type -> hbf.v2.sgroups.ListSvcSvcRulesResp
	24, // 27: hbf.v2.sgroups.SecGroupService.GetSgSubnets:output_type -> hbf.v2.sgroups.GetSgSubnetsResp
	25, // 28: hbf.v2.sgroups.SecGroupService.GetSecGroupForAddress:output_type -> hbf.v2.sgroups.SecGroup
	25, // 29: hbf.v2.sgroups.SecGroupService.GetSecGroupForHost:output_type -> hbf.v2.sgroups.SecGroup
	26, // 30: hbf.v2.sgroups.SecGroupService.FindSgSgRules:output_type -> hbf.v2.sgroups.SgSgRulesResp
	27, // 31: hbf.v2.sgroups.SecGroupService.FindFqdnRules:output_type -> hbf.v2.sgroups.FqdnRulesResp
	28, // 32: hbf.v2.sgroups.SecGroupService.FindSgIcmpRules:output_type -> hbf.v2.sgroups.SgIcmpRulesResp
	29, // 33: hbf.v2.sgroups.SecGroupService.FindSgSgIcmpRules:output_type -> hbf.v2.sgroups.SgSgIcmpRulesResp
	30, // 34: hbf.v2.sgroups.SecGroupService.FindIECidrSgRules:output_type -> hbf.v2.sgroups.IECidrSgRulesResp
	31, // 35: hbf.v2.sgroups.SecGroupService.FindIESgSgRules:output_type -> hbf.v2.sgroups.IESgSgRulesResp
	32, // 36: hbf.v2.sgroups.SecGroupService.FindIESgSgIcmpRules:output_type -> hbf.v2.sgroups.IESgSgIcmpRulesResp
	33, // 37: hbf.v2.sgroups.SecGroupService.FindIECidrSgIcmpRules:output_type -> hbf.v2.sgroups.IECidrSgIcmpRulesResp
