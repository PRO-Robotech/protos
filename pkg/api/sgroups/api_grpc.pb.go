...
type SecGroupServiceClient interface {
	...
	SyncStatuses(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[SyncStatusResp], error)
...
func (c *secGroupServiceClient) SyncStatuses(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[SyncStatusResp], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type SecGroupServiceServer interface {
	...
	SyncStatuses(*emptypb.Empty, grpc.ServerStreamingServer[SyncStatusResp]) error
...
func (UnimplementedSecGroupServiceServer) SyncStatuses(*emptypb.Empty, grpc.ServerStreamingServer[SyncStatusResp]) error {
...
func _SecGroupService_SyncStatuses_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(SecGroupServiceServer).SyncStatuses(m, &grpc.GenericServerStream[emptypb.Empty, SyncStatusResp]{ServerStream: stream})
}
